...
const ProfilePage = () => {
  ...
  const[name, setName] = useState("Janit Dev")
  const [bio, setBio] = useState("Hi Everyone,I am ready to chat!!")
      ...
      <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300 border-2 border-gray-600 flex items-center justify-between max-sm:flex-col-reverse rounded-lg'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
          ...
          <input onChange={(e)=>setName(e.target.value)} value={name} 
            ...
            placeholder='Write you bio' required className='p-2 border
            border-gray-500 rounded-md focus:outline-none focus:ring-2
            focus:ring-indigo-500' rows={4}></textarea>
